    ...
    <div className={`min-h-screen transition-colors duration-300 ${themeClasses.background}`}>
      ...
      <section className={`relative ${themeClasses.heroBg} py-20 px-4 sm:px-6 lg:px-8 transition-colors duration-300`}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className={`text-xl font-sans ${themeClasses.textSecondary} mb-8 max-w-3xl mx-auto transition-colors duration-300 leading-relaxed`}>
      ...
      <section className={`py-20 px-4 sm:px-6 lg:px-8 ${themeClasses.sectionBg} transition-colors duration-300`}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className={`text-3xl md:text-4xl font-heading font-bold ${themeClasses.textPrimary} mb-4 transition-colors duration-300`}>
            ...
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className={`text-xl font-heading font-semibold ${themeClasses.textPrimary} mb-3 transition-colors duration-300`}>{feature.title}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div>
                  <div className={`font-sans font-semibold ${themeClasses.textPrimary} transition-colors duration-300`}>{testimonial.name}</div>
                  <div className={`text-sm font-sans ${themeClasses.textSecondary} transition-colors duration-300`}>{testimonial.role}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className={`py-20 px-4 sm:px-6 lg:px-8 ${themeClasses.sectionBg} transition-colors duration-300`}>
        <div className="max-w-4xl mx-auto text-center">
          <h2 className={`text-3xl md:text-4xl font-heading font-bold ${themeClasses.textPrimary} mb-6 transition-colors duration-300`}>
