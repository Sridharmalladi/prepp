        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Link
                to="/register"
                className="bg-gradient-to-r from-teal-500 to-cyan-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:from-teal-600 hover:to-cyan-600 transition-all duration-200 shadow-md hover:shadow-lg"
              >
                Get Started
              </Link>
            </div>
            ...
            <button
              ...
              className="md:hidden p-2 rounded-md text-gray-700 hover:text-teal-600 hover:bg-gray-50 transition-colors duration-200"
            >
            ...
            <div className="space-y-2">
              ...
              <div className="pt-4 border-t border-gray-200 space-y-2">
                ...
                <Link
                  to="/register"
                  onClick={() => setIsMenuOpen(false)}
                  className="block px-3 py-2 text-base font-medium bg-gradient-to-r from-teal-500 to-cyan-500 text-white rounded-md hover:from-teal-600 hover:to-cyan-600 transition-all duration-200"
                >
                  Get Started
                </Link>
              </div>
